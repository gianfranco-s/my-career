...
[DONE] **Iteration 3 (API)**: implement HTTP API to return roles, and filtered work experience. Iterate over FastAPI, Flask, maybe Django. PDF needs to be able to be downloaded.  
